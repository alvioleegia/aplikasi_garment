<?php $pageTitle = 'View Warna'; $pageActive = 'warna'; ?>
			...
			<div class="col-md-6">
				<div class="box box-primary">
					<div class="box-header">
						<h3 class="box-title">Warna Kain #<?php echo $data['id_kain']; ?></h3>
					</div>
					<div class="box-body">
						...
						<div class="form-group">
							<label>Kain</label>
							<p><?php echo getKain($data['id_kain']); ?></p>
						</div>
